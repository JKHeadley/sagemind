...
const teamData = {
  en: [
    ...
    },
    {
      ...
      bio: "With more than two decades of clinical excellence, Dra. Hernández Bonilla is the heart and driving force behind Dental City. A graduate of the University of Costa Rica (UCR), with advanced training in implantology at the University of Miami and an active member of the International Congress of Oral Implantologists (ICOI), she combines a solid academic foundation with high-level clinical execution. Certified in facial harmonization and currently pursuing an advanced diploma in orofacial harmonization from a Brazilian university, she achieves results that enhance each patient's individual beauty without losing naturalness — her training has focused on understanding the face as a whole, achieving a natural balance between the smile and facial features. Beyond her clinical work, Dra. Hernández Bonilla is the one who leads and coordinates every detail within Dental City. Her commitment goes beyond treatment — she ensures that every patient has a safe, comfortable, and truly exceptional experience.",
    },
    {
  ...
  es: [
    ...
    },
    {
      ...
      image: "/images/team-dra-hernandez.jpg",
      bio: "Con más de dos décadas de excelencia clínica, la Dra. Hernández Bonilla es la fuerza y el corazón detrás de Dental City. Graduada de la Universidad de Costa Rica (UCR), con formación avanzada en implantología en la Universidad de Miami y miembro activo del International Congress of Oral Implantologists (ICOI), combina una sólida preparación académica con una ejecución clínica de alto nivel. Certificada como armonizadora facial y actualmente cursando un diplomado en armonización orofacial de una universidad brasileña, logra resultados que realzan la belleza individual de cada paciente sin perder naturalidad, ha enfocado parte de su formación en comprender el rostro como un todo, logrando un balance natural entre la sonrisa y las facciones. Además de su labor clínica, la Dra. Hernández Bonilla es quien lidera y coordina cada detalle dentro de Dental City. Su compromiso va más allá del tratamiento, vela por que cada paciente viva una experiencia segura, cómoda y verdaderamente excepcional.",
    },
    {
      name: "Dra. Angie Arcia Umaña",
